...
#' @export
generate_rmd_skeleton <- function(dataset_input, var_date, var_target, target_kpis, models, column_kpi, split_date = NULL, horizon = NULL, lags = NULL, use_holidays = NULL, country_column = NULL, path_driver = NULL, use_meteo = NULL, tuning = FALSE, spark_conection = NULL, draft_file = "/stability_template.Rmd", export_file = "/multiplekpis_report.Rmd") {
  path_rmarkdown <- system.file("rmarkdown", package = "th2forecast")
  ...
  report_params <- list(data = dataset_input, var_date = var_date, var_target = var_target, kpi = target_kpis, models = models, column_kpi = column_kpi, split_date = split_date, horizon = horizon, lags = lags, use_holidays = use_holidays, country_column = country_column, path_driver = path_driver, use_meteo = use_meteo, tuning = tuning)
