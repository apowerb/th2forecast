...
#'
#' Une fonction qui prend une liste de modèles entraînés à calibrer avec les données de test et qui calcule ensuite les différentes mesures d'évaluation.
#'
...
#' @import tidymodels
#'
#' @return une liste avec 2 éléments : 1. modèles calibrés 2. résultats des métriques d'évaluation
#' @export
#'
